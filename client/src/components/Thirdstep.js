          ...
          <div className='pricing__container'>
            <Link to='/' className='pricing__container-card'>
              <div className='pricing__container-cardInfo'>
                ...
                <Button buttonSize='btn--wide' onClick={()=>setStep(4)} buttonColor='primary'>
                Choose Plan
              </Button>
              </div>
            ...
            <Link to='/sign-up' className='pricing__container-card'>
              <div className='pricing__container-cardInfo'>
                <div className='icon'>
                <img src="/img/Groupe 2228.png" className="iconimg" alt="icon-pricing" />
                ...
                <div className='pricing__container-cardInfo'>
                    <div className='icon'>
                    <img src="/img/company (1).png" className="iconimg" alt="icon-pricing" />
                ...
                <div className='pricing__container-cardInfo'>
                <div className='icon'>
                <img src="/img/Tracé 63.png" className="iconimg" alt="icon-pricing" />
